...
class nuScenes_One_Frame_Eval:
    def __init__(
        ...
        self.aug_rot = np.eye(2)* resize_scale
        self.aug_trans = -np.array([self.origin_size[1]*resize_scale-self.crop_size[1], self.origin_size[0]*resize_scale-self.crop_size[0]])
