...
class LSSFPN3D(nn.Module):
    ...
    def forward(self, feats):
        x_8, x_16, x_32 = feats
        x_16 = torch.nn.functional.interpolate(x_16, size=x_8.shape[2:], mode='trilinear', align_corners=True)
        x_32 = torch.nn.functional.interpolate(x_32, size=x_8.shape[2:], mode='trilinear', align_corners=True)
        # x_16 = self.up1(x_16)
        # x_32 = self.up2(x_32)
